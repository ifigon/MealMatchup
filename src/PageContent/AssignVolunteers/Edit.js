                                ...
                                for (let i = 0; i < 2; i++) {
                                    ...
                                    volunteerRows.push(
                                        <div key={i} className="form-child">
                                            ...
                                            <input name={`phone${(i + 1)}`} onChange={formatPhone} type="tel" onChange={formatPhone} pattern={StringFormat.PHONE} className="form-input" defaultValue={present ? deliverers[i].phone : ''} required/><br />
