...
describe('Day', () => {
    it('applies given classNames properly', () => {
        ...
        expect(wrapperClassName.includes('react-calendar__tile--flag')).toBe(
            true
        );
        expect(
    ...
    it('applies additional classNames for neighboring months', () => {
        const component = mount(
            <Day {...tileProps} date={new Date(2018, 1, 2)} />
        );
    ...
    it('renders time component with proper dateTime arguments', () => {
        const component = mount(
            <Day {...tileProps} date={new Date(2018, 0, 1)} />
        );
    ...
    it('is disabled when date is before beginning of minDate\'s day', () => {
        ...
        expect(component.find('.react-calendar__tile').prop('disabled')).toBe(
            true
        );
    });
