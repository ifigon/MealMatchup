...
import './RequestGeneralVolunteer.css';
import GeneralVolunteerSummary from './GeneralVolunteerSummary.js';
import GeneralVolunteerConfirmation from './GeneralVolunteerConfirmation';
import moment from 'moment-timezone';

class RequestGeneralVolunteer extends Component {
    constructor(props) {
        ...
        this.formId = 'generalVolunteerForm';
        ...
        return (
            <div className="form">
                <form id={this.formId} onSubmit={this.createRequest}>
                    <div className="info">
                        <p id="form-heading">Request General Volunteer</p>
                        ...
                        <span className="grid">
                            <p id="form-heading">Notes for Volunteer</p>
                            <textarea
                                name="notes"
                ...
                {this.state.showPopup && (
                    <GeneralVolunteerSummary
                        title={'Request General Volunteer'}
...
export default RequestGeneralVolunteer;
