    ...
    render() {
        return (
            <div className="navbar">
                <NavBarItem
                    highlighted={this.props.content === PageContent.CALENDAR}
                ...
                {this.props.accountType === AccountType.DELIVERER_GROUP && (
                    <NavBarItem
                        highlighted={
                            this.props.content === PageContent.ASSIGN_VOLUNTEERS
                        }
                ...
                <NavBarItem
                    highlighted={this.props.content === PageContent.FOOD_LOGS}
                    item={PageContent.FOOD_LOGS}
                    icon={foodLog}
                    handler={this.props.handler}
                />
                <NavBarItem
                    highlighted={this.props.content === PageContent.DIRECTORY}
                    item={PageContent.DIRECTORY}
                    icon={directory}
                    handler={this.props.handler}
                />
                <NavBarItem
                    highlighted={this.props.content === PageContent.SETTINGS}
