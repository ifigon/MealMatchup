            ...
            <div className="modal-wrapper">
                ...
                <div className="details-scroll">
                    <div className="pickup-details">
                        <RequestTime request={details} />
                    </div>
                    <div className="flex">
                        <div className="donating-agency">
                            <h2 id="organizationName">Donating Agency</h2>
                            <p className="donating-recieving" id="donatingAgency">{details.daInfo.name}</p>
                            <p className="donating-recieving" id="donatingContactName">{details.daInfo.primaryContact.name}</p>
                            <p className="donating-recieving" id="donatingContactPhone">{details.daInfo.primaryContact.phone}</p>
                            <p className="donating-recieving" id="donatingContactEmail">{details.daInfo.primaryContact.email}</p>
                        </div>
                    ...
                    }
                    {
                        ...
                        <div className="receiving-agency">
                            <h2>Student Group</h2>
                            <p className="donating-recieving" id="donatingAgency">{details.dgInfo.name}</p>
                            <p className="donating-recieving" id="receivingContactName">{details.dgInfo.primaryContact.name}</p>
                            <p className="donating-recieving" id="receivingContactPhone">{details.dgInfo.primaryContact.phone}</p>
                            <p className="donating-recieving" id="receivingContactEmail">{details.dgInfo.primaryContact.email}</p>
                        </div>
                    }
                </div>
            </div>
