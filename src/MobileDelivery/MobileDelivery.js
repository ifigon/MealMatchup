            ...
            <div className="mobile-delivery">
                ...
                <div className="mobile-card">
                    ...
                    <p className="ms-pickup-time">
                        Deliver by{' '}
                        {moment(
                            this.props.currentDelivery.timePickedUp,
                            'HH:mm'
                        )
                            .add(3, 'hours')
                            .format('LT')}
                    ...
                    <a
                        id="ms-address"
                        href={'geo:' + this.state.lat + ',' + this.state.long}
                        target="_blank"
                    >
                    ...
                    <div className="ms-content">
                        ...
                        <div id="ms-contact">
                            ...
                            <p id="ms-name">
                                {this.props.ra.primaryContact.name}
                            </p>
                            <p id="ms-position">
                                {this.props.ra.primaryContact.position}
                            </p>
                            <a
                                href={
                                    'tel:' + this.props.ra.primaryContact.phone
                                }
                            >
                    ...
                    <form onSubmit={this.onSubmit}>
                        <div id="ms-confirm">
                            <p className="ms-content-header">
                                Confirmation Signature
                            </p>
                            <p className="ms-notes">
                                Get a confirmation signature and printed name
                                from
                                {this.props.ra.primaryContact.name} at the non
                                profit after you drop-off food items at the
                                destination.
                            </p>
                            {/* TODO: Signature */}
                            <input
